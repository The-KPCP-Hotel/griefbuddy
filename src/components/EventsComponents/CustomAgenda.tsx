...
import { Event as EventType, Navigate as navigate } from 'react-big-calendar';
// import { inRange } from './utils/eventLevels';
// import { inRange } from 'react-big-calendar';
// import { isSelected } from './utils/selection';
import isEqual from 'lodash/isEqual';

function inRange(e: any, start: any, end: any, accessors: any, localizer: any) {
  const event = {
...
function Agenda({
  ...
  components: { event: EventType; date: any };
  date: Date;
  events: EventType[];
  getters: {
    eventProp: (
      ...
      isSelected: (event: Event, selected: Event) => {},
    ) => {};
  };
  length: number;
  localizer: {
